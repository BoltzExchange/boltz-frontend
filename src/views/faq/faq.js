...
const whatIsBoltz = "Boltz is an instant and non custodial crypto currency exchange" +
...
const howToOpen = 'We appreciate an channels you open with out Lightning nodes' +
      ...
      <BackGround>
        ...
        <View className={classes.wrapper}>
          ...
          <View className={classes.questionTab}>
            <Question title={'What is Boltz?'} content={whatIsBoltz} width={'auto'} />
            <Question title={'How to open a lightning channel?'} content={howToOpen} width={'auto'} />
